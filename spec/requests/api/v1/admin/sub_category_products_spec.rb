...
RSpec.describe "Api::V1::Admin::SubCategoryProducts", type: :request do
  ...
  describe "GET /index" do
    ...
    it "user fail to get all sub_category_products" do
  ...
  describe "GET /show" do
    it "admin succes to get 1 sub_category_product" do
      auth_tokens = sign_in(admin)
      get api_v1_admin_sub_category_product_path(sub_category_product.id), headers: auth_tokens
      expect(response).to have_http_status :ok
    end

    it "user fail to get 2 sub_category_product" do
      auth_tokens = sign_in(user2)
      get api_v1_admin_sub_category_product_path(sub_category_product2.id), headers: auth_tokens
      expect(response).to have_http_status :unauthorized
    end
  end
  ...
  describe "POST /create" do
    ...
    it "user fail to post sub_category_product" do
      auth_tokens = sign_in(user2)
      params={
        sub_category_product: {
          name: "test sub_category_product posted",
  ...
  describe "PATCH/PUT /update" do
    ...
    it "user fail to update 2 sub_category_product" do
      auth_tokens = sign_in(user2)
      params={
        sub_category_product: {
        name: "test sub_category_product posted",
  ...
  describe "DELETE /destroy" do
    ...
    it "user fail to delete 2 sub_category_product" do
      auth_tokens = sign_in(user2)
