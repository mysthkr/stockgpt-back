...
RSpec.describe "Api::V1::Admin::Items", type: :request do
  ...
  describe "GET /index" do
    ...
    it "user fail to get all items" do
  ...
  describe "GET /show" do
    it "admin succes to get 1 item" do
      auth_tokens = sign_in(admin)
      get api_v1_admin_item_path(item.id), headers: auth_tokens
      expect(response).to have_http_status :ok
    end

    it "user fail to get 2 item" do
      auth_tokens = sign_in(user2)
      get api_v1_admin_item_path(item2.id), headers: auth_tokens
      expect(response).to have_http_status :unauthorized
    end
  end
  ...
  describe "PATCH/PUT /update" do
    ...
    it "user fail to update 2 item" do
      auth_tokens = sign_in(user2)
      params={
        item: {
          name: "updated item"
  ...
  describe "DELETE /destroy" do
    ...
    it "user fail to delete 2 item" do
      auth_tokens = sign_in(user2)
