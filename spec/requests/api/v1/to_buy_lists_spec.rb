...
RSpec.describe "Api::V1::ToBuyLists", type: :request do
  ...
  describe "GET /index" do
    it "admin succes to get all to_buy_lists" do
      ...
      get api_v1_to_buy_lists_path, headers: auth_tokens
      expect(response).to have_http_status :ok
    end

    it "user succes to get all to_buy_lists" do
  ...
  describe "GET /show" do
    it "admin succes to get 1 to_buy_list" do
      auth_tokens = sign_in(admin)
      get api_v1_to_buy_list_path(to_buy_list3.id), headers: auth_tokens
      expect(response).to have_http_status :ok
    end

    it "user succes to get 2 to_buy_list" do
      auth_tokens = sign_in(user2)
      get api_v1_to_buy_list_path(to_buy_list.id), headers: auth_tokens
      expect(response).to have_http_status :ok
    end

    it "user fail to get 2 to_buy_list" do
      auth_tokens = sign_in(user2)
      get api_v1_to_buy_list_path(to_buy_list2.id), headers: auth_tokens
  ...
  describe "POST /create" do
    it "admin succes to post to_buy_list" do
      ...
      post api_v1_to_buy_lists_path, params: params, headers: auth_tokens
    ...
    it "user succes to post to_buy_list" do
      auth_tokens = sign_in(user2)
      params={
        to_buy_list: {
          group_id: group3.id,
  ...
  describe "PATCH/PUT /update" do
    ...
    it "user succes to update 2 to_buy_list" do
      auth_tokens = sign_in(user2)
      params={
        to_buy_list: {
          buy_flag: true
