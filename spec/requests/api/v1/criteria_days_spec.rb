...
RSpec.describe "Api::V1::CriteriaDays", type: :request do
  ...
  describe "GET /index" do
    it "admin succes to get all criteria_days" do
      ...
      get api_v1_criteria_days_path, headers: auth_tokens
  ...
  describe "POST /create" do
    it "admin succes to post criteria_day" do
      ...
      post api_v1_criteria_days_path, params: params, headers: auth_tokens
