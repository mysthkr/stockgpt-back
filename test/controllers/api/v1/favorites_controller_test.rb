...
class Api::V1::FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_favorite" do
    assert_difference('Api::V1::Favorite.count') do
      post api_v1_favorites_url, params: { api_v1_favorite: { group_id: @api_v1_favorite.group_id, item_id: @api_v1_favorite.item_id } }, as: :json
    end
  ...
  test "should update api_v1_favorite" do
    patch api_v1_favorite_url(@api_v1_favorite), params: { api_v1_favorite: { group_id: @api_v1_favorite.group_id, item_id: @api_v1_favorite.item_id } }, as: :json
    assert_response 200
  end
