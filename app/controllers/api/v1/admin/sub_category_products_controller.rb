class Api::V1::Admin::SubCategoryProductsController < Api::V1::SubCategoryProductsController
  ...
  private
    ...
    def sub_category_product_params
      params.require(:sub_category_product).permit(:name, :category_product_id)
    end
end
